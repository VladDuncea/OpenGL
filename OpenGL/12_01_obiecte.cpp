...
//  myMatrix = glm::scale(glm::vec3(0.5, 0.5, 0.5)) * glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 0.f,-50));
//  myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix");
//  glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
//  glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_BYTE, 0);
//  glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_BYTE,(void*)(6));
//
//  int v[10] = { 0,50,120,190,350,550,700 };
//  for (int i = 0; i < 6; i++)
//  {
//      float s = 1 - 0.15 * i;
//      // desenare con
//      myMatrix = glm::scale(glm::vec3(s,s,s)) * glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 0.f, 50.0+v[i]));
//      myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix");
//      glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
